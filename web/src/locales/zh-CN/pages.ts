export default {
  ...
  'pages.login.accountLogin.errorMessage': '用户名或密码错误（admin)',
  ...
  'pages.redisConnectionManage.searchTable.title' :"Redis连接",
  'pages.redisConnectionManage.createForm.newRedisConnection' :"新建Redis连接",
  'pages.redisConnectionManage.createForm.updateRedisConnection' :"修改Redis连接",
  'pages.redisConnectionManage.update': '修改',
  'pages.redisConnectionManage.id': '连接ID',
  'pages.redisConnectionManage.name': '连接名称',
  'pages.redisConnectionManage.host': '连接地址',
  'pages.redisConnectionManage.port': '连接端口',
  'pages.redisConnectionManage.password': '连接密码',
  'pages.redisConnectionManage.username': '连接用户名',
  'pages.redisConnectionManage.type': '连接类型',
